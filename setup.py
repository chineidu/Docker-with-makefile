...
test_packages = ["pytest==7.1.2", "pytest-cov==2.10.1", "evidently==0.2.1"]

# Define our package
setup(
    name="simple-project",
    version=0.1,
    description="Simple Project Development With Docker.",
    author="Chinedu Ezeofor",
    author_email="neidu@email.com",
    url="https://github.com/chineidu/Docker-with-makefile",
    python_requires=">=3.8",
